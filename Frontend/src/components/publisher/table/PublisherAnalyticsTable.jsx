...
import AdAnalyticsLineChart from "@/components/publisher/charts/AdAnalyticsLineChart";
import AdRevenueBarChart from "@/components/publisher/charts/AdRevenueBarChart";
import {FaAngleUp, FaAngleDown }from "react-icons/fa6";

function PublisherAnalyticsTable() {
        ...
        <div>
            <div className="min-h-screen bg-gray-100 p-4 lg:p-2">
                <div className="w-full lg:p-6">
                    <div className="min-h-[65vh] bg-gray-100">
                        <div className="flex justify-between items-center mb-4">
                            <h1 className="text-lg lg:text-xl font-bold text-[#444444]">Website Analytics</h1>
                            <select
                                value={filter}
                                onChange={handleFilterChange}
                                className="py-2 px-3 border bg-white border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-300 font-semibold text-sm"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <AdAnalyticsLineChart filter={filter} />
                            <AdRevenueBarChart filter={filter} />
                        </div>
                    </div>
                    ...
                    <div className="w-full bg-white rounded-lg p-4 lg:p-6 mt-6">
                                    ...
                                    <table className="w-full bg-white rounded-lg">
                                        <thead>
                                            <tr className="bg-[#5B6CFF] text-white text-center rounded-lg">
                                                <th className="px-5 py-4 whitespace-nowrap font-semibold text-sm">
                                                    <input
                                                        type="checkbox"
                                                ...
                                                <th className="px-6 py-4 whitespace-nowrap">Website Name </th>
                                                <th className="px-6 py-4 whitespace-nowrap">Website URL</th>
                                                <th className="px-6 py-4 whitespace-nowrap">Created Date and Time </th>
                                                <th className="px-6 py-4 whitespace-nowrap">Updated Date and Time </th>
                                                <th className="px-6 py-4 whitespace-nowrap">Category</th>
                                                <th className="px-6 py-4 whitespace-nowrap">Ad Position</th>
                                                ...
                                                <th className="px-6 py-4 whitespace-nowrap flex items-center justify-center">
                                                    <span className="flex items-center justify-center">
                                                        Clicks
...
export default PublisherAnalyticsTable;