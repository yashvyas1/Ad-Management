...
function AddPublisherManualPayment({ data }) {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-gray-600 font-medium text-sm">
                    Publisher Name <span className="text-red-700">*</span>
                  </label>
                  <Field
                    name="adName"
                ...
                <div>
                  <label className="text-gray-600 font-medium text-sm">
                    Website Name <span className="text-red-700">*</span>
                  </label>
                  <Field
                    name="advertiserName"
                    className="border rounded-md p-2 w-full "
...
export default AddPublisherManualPayment;
