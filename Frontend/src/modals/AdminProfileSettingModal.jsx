...
function AdminProfileSettingModal({ data, onSave }) {
          ...
          {({ values, setFieldValue, errors, touched, isSubmitting }) => (
            <Form>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col mb-4">
                  <label className="text-[#939393] font-medium text-sm">
                    Email ID
                  </label>
                  <Field
                    name="email"
                    className="border border-gray-300 rounded-md p-2 w-full outline-none text-[#939393] cursor-not-allowed"
              ...
              <div className="flex justify-end mt-6">
                <Button
                  type="submit"
                  className="bg-[#5B6CFF] text-white px-16 py-2 rounded-md hover:bg-[#5162fa]"
                >
                  Save
                </Button>
              </div>
...
export default AdminProfileSettingModal;
