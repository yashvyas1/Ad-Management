  ...
  return (
    <div className="space-y-4 min-h-screen">
      ...
      <div className="p-4 bg-white rounded-md shadow-lg">
        ...
        <div className="flex justify-between items-center border-b pb-2 border-gray-200 pt-4">
          <span className="text-gray-600">Payment Due Reminder</span>
          <div
            className={`w-12 h-6 flex items-center rounded-full p-1 cursor-pointer ${
              settings.paymentDueReminder && settings.allNotifications
                ? "bg-blue-500"
                : "bg-gray-300"
            } ${
              settings.allNotifications ? "" : "opacity-50 cursor-not-allowed"
            ...
            onClick={() =>
              settings.allNotifications && toggleSetting("paymentDueReminder")
            }
          >
            <div
              className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform ${
                settings.paymentDueReminder ? "translate-x-6" : "translate-x-0"
              }`}
            />
          </div>
        </div>
